...
/**
 * Resolves the active skin for AppWidget rendering without blocking the
 * Glance rendering thread.
 *
 * Glance rendering is already suspend-aware, so widget callers resolve the
 * persisted settings before entering provideContent rather than using
 * runBlocking inside composition.
 */
